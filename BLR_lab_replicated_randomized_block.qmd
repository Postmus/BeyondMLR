...
## A Mixed Effects Model for the Replicated Randomized Block Design
...
```{r}
#| include: false
emmeans_model_block <- emmeans(model_block, ~ Treatment)
emmeans_model_block

pairs(emmeans_model_block, adjust = "bonferroni")
```
...
## Exploring the impact of omitting the random interaction term from the mixed effects model 
