...
# Load the data
asian_data <- read.csv("/home/simalgo/BeyondMLR/Assignments/Week 4/downloads/asian_data.csv")
...
3. **Gender × time interaction:** If retained in the final model, this would indicate that boys and girls have different growth rates. If eliminated by `step()`, it suggests the trajectories are parallel (same growth pattern, different baseline).
