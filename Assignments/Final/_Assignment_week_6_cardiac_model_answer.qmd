...
subtitle: "Model answer (Example: Quality of Life with Diabetes as moderator)"
format:
  html:
    toc: true
    toc-depth: 3
...
1. Does the rehabilitation program (Standard vs Enhanced) affect the recovery trajectory of Quality of Life?
2. Does diabetes affect the recovery trajectory of Quality of Life?
3. Is there an interaction between the rehabilitation program and diabetes in their effect on Quality of Life trajectory?
...
cat("Last two digits: 37 -> Quality of Life + Diabetes\n")
