...
<!--
### Reporting
A one-way ANOVA showed a statistically significant effect of treatment on blood pressure reduction, F(2, 117) = 43.71, p < 0.001. Estimated marginal means (95% CI) were 19.9 (17.1, 22.8) mm Hg for Drug A, 5.1 (2.3, 7.9) mm Hg for Drug B, and 2.5 (−0.4 – 5.3) mm Hg for the Control group. Pairwise comparisons (Bonferroni-adjusted) indicated statistically significant differences between Drug A and both Drug B (p < 0.001) and the Control group (p < 0.001), but not between Drug B and the Control group (p = 0.586).
-->
