...
## Assignment week 3: key findings

::: {style="font-size: 0.85em;"}

**Dataset**: ILEA school effectiveness data (15,362 students nested in 140 schools)

**Variance partitioning**

- ICC ≈ 12% — modest but non-trivial between-school variation
- Multilevel approach ensures correct standard errors and enables school-level inference

**Individual-level effects (Level 1)**

- Gender and Verbal Reasoning Band (VRBand) significantly predict exam scores
- Large effects: VRBand explains substantial variation in outcomes

**Context-level effects (Level 2)**

- Schools with higher % free school meals (PercentFSM) have lower average scores
- School denomination also matters (though effect sizes are modest)

**Cross-level interaction**

- VRBand × PercentFSM statistically significant but practically modest
- ~1.7 point difference in ability gap between low vs. high FSM schools
