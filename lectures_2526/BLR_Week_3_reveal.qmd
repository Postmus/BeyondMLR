...
- Grouped data arise when units of analysis share common conditions defined by one or more context variables
  ...
  - The extent of this dependence is described by the ICC

- Two-level hierarchical data
  - Randomized block design: experimental units (level 1) nested in blocks (level 2)
  - Treatment is a level-1 variable because treatments vary at the level of individual experimental units
  - Ignoring blocks (using OLS) yields unbiased treatment estimates but is inefficient because block-to-block variation is absorbed into the residual, inflating the residual variance and lowering power

- Cross-classified data
  - Units of analysis belong to combinations of two (or more) non-nested higher-level units
    - Tumor volume measurements cross-classified by patient and radiologist
  - In medical settings this structure is often used to assess inter-rater agreement
