...
- Adding a level 3 grouping reveals additional clustering at that level, which reduces the effective number of independent units for estimating level 2 effects

- Level 1 coefficients change little because they rely on within-neighborhood variation, which is not strongly affected by adding a district level

- Level 2 coefficients often show larger standard errors because neighborhoods within the same district are correlated, reducing the amount of independent between-neighborhood information

- The model reallocates part of the between-neighborhood variation to the district level, leaving less usable variation for estimating level 2 effects
