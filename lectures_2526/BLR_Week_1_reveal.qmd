...
## Requirements to earn course cerfificate
...
- Analysis stage
  ...
  - This additive model separates block effects ($\beta_j$) from residual error ($\varepsilon_{ijk}$), reducing unexplained variability and allowing treatment effects to be estimated with greater precision
...
- This reduces power compared with models that adjust for cages
