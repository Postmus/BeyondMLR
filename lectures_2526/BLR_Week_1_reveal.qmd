...
ggplot(df_weight, aes(x = Treatment, y = Weight_change, fill = Treatment)) +
  geom_boxplot(color = "black") +
  scale_fill_manual(values = c("gray85", "skyblue", "lightgreen")) +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray") +
  labs(y = "Change in body weight (kg)", x = NULL) +
...
- In the two-way additive ANOVA with cage as a random effect, that unexplained variability is partitioned into:
